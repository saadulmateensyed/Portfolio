...
- **Network Security:** Firewalls Configuration & Management (Palo Alto, Cisco ASA, Juniper SRX, Checkpoint), IPS/IDS, VPN (IPSec, SSL),
- **Vulnerability Management:** CrowdStrike Falcon, Qualys VMDR, Rapid7 InsightVM & Tenable.io
...
- **SIEM & Threat Management:** SIEM (Splunk, IBM QRadar SIEM, Microsoft Azure Sentinel & Elastic Stack)
...
- **Cloud Security:** CASB (Netskope, Prisma Cloud & Symantec CloudSOC CASB) SASE (Palo Alto SASE, Zscaler SASE)
- **Secure Access Control:** (Cisco ISE, Aruba ClearPass)
- **Network Protocols:** (TCP/IP, DNS, DHCP, BGP, OSPF, VTP, STP)
- **Security Compliance & Auditing:** PCI, HIPAA, GDPR, SOX, NIST 800-53, ISO 27001, FISMA, FedRAMP, HITRUST CSF
...
Vulnerability Analysis: Conducted thorough analysis and categorization of detected vulnerabilities, implementing solutions that decreased high-risk vulnerabilities by 30%.
...
Compliance Audits: Led compliance audits, achieving a 100% compliance rate and avoiding fines.
...
- **GPA:** 3.93
- **Relevant Courses:** Information Assurance and Risk Management, IT Security Audit and Compliances, Firewalls and Intrusion Detection, Database Security, Wireless Network Security, Applied Cryptography, Penetration Testing.

### Bachelor of Engineering in Electronics & Communication Engineering from Osmania University (Hyderabad, India)
- **Graduation Date:** May 2015
- **Relevant Courses:** Computer Organization and Architecture, Computer Networks, Embedded Systems, Digital Communications, Microprocessors and Microcontrollers.

## Seeking Opportunities 🌟

I am currently seeking opportunities in IT Security and Network Security domains at reputed organizations. I am eager to apply my skills and experiences to innovative projects and make meaningful contributions to the cybersecurity landscape.
